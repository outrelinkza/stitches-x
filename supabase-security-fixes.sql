...
DROP VIEW IF EXISTS public.gdpr_compliance_dashboard;
...
-- Recreate security dashboard without SECURITY DEFINER
...
-- 2. Fix function search_path issues - Add SET search_path to all functions
