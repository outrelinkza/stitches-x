...
-- 7. Create function to send invoice email
...
-- 8. Create function to send welcome email
...
-- 9. Create function to send payment confirmation email
...
-- 12. Insert default email templates
